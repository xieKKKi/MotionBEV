...
def main(arch_config, data_config):
    ...
    elif data_cfg['dataset_type'] == 'polar-livox':
        fea_dim = 9
        circular_padding = False
    else:
    ...
    if data_cfg['dataset_type'] == 'polar':
        ...
        train_dataset = spherical_dataset(train_pt_dataset,
                                          ...
                                          transform_aug=data_cfg['transform_aug'],
                                          fixed_volume_space=data_cfg['fixed_volume_space'],
                                          max_volume_space=[50.15, 0.62, 1.5],
                                          min_volume_space=[1.85, -0.62, -2.0],
                                          is_livox=True)
        val_dataset = spherical_dataset(val_pt_dataset,
                                        grid_size=model_cfg['grid_size'],
                                        fixed_volume_space=data_cfg['fixed_volume_space'],
                                        max_volume_space=[50.15, 0.61, 1.5],
                                        min_volume_space=[1.85, -0.61, -2.0],
                                        is_livox=True)
    else:
        raise NotImplementedError
...
if __name__ == '__main__':
    arch_config_path = "config/MotionBEV-livox.yaml"
    data_config_path = "config/livox-SEU-MOS.yaml"
